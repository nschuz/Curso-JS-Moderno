...
resultado = [].concat(_toConsumableArray(resultado), [producto2]); //Elimanar ultimo elemnto dde un arreglo 

carrito.pop(); //Elimnar al inicio del arreglo 

carrito.shift(); //Elimnar cualquier lemento 
