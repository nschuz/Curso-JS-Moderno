...
function cargarEventListeners(){
    ...
    //MUnestra los curso del html
    document.addEventListener('DOMContentLoaded', ()=>{
        artriculosCarrito= JSON.parse(localStorage.getItem('carrito')) || [];
        carritoHtml();
    });
...
limpiarHtml();
    ...
    //Agrgar al carrito localstroarge
    sincronizarStorage();
...
function sincronizarStorage(){
   localStorage.setItem('carrito' ,JSON.stringify(artriculosCarrito)); 
